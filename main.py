...
class Snake:
    ...
    def draw(self, painter):
        for position in self.positions:
            painter.fillRect(position[0], position[1], 14, 14, GREEN)
...
class Fruit:
    ...
    def draw(self, painter):
        painter.fillRect(self.position[0], self.position[1], 14, 14, RED)
...
class SnakeGame(QMainWindow):
    def __init__(self):
        ...
        self.btn_start.setGeometry(250, 200, 100, 50)
        ...
        self.btn_exit.setGeometry(250, 400, 100, 50)
        ...
        self.level_drop.setGeometry(150, 200, 100, 25)
    ...
    def set_level(self):
        if self.level_drop == "Лёгкий":
            self.snake.timer.start(60)
        elif self.level_drop == "Средний":
            self.snake.timer.start(45)
        elif self.level_drop == 'Сложный':
